...
class FollowsController extends Controller
{
    ...
    public function followList(Request $request){
        ...
        $followee_posts = Post::with('user')->whereIn('user_id',$followees_id)->orderBy('created_at','desc')->get();
    ...
    public function followerList(){
        ...
        $follower_posts = Post::with('user')->whereIn('user_id',$followers_id)->orderBy('created_at','desc')->get();
